...
log "  | eval etype=coalesce(event_sourcetype, sourcetype)"
log "  | stats count by etype"
log ""
log "Expected (incident trace tr_file_share_001):"
log "  ai:agent_log : 4"
log "  ai:chat      : 2"
log "  ai:metric    : 3  (ai_request, ai_cost, prompt_injection)"
log "  ai:trace     : 7"
log "  edr:process  : 1"
log "  total        : 17"
log ""
...
log ""
log "Full dataset (all 26 events including 3 baseline runs):"
log "  index=${SPLUNK_INDEX} | stats count by sourcetype"
